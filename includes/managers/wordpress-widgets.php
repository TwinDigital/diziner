...
class WordPress_Widgets_Manager {
	...
	public function before_enqueue_scripts() {
		...
		$wp_scripts->add( 'media-widgets', "/wp-admin/js/widgets/media-widgets$suffix.js", [
			'jquery',
			'media-models',
			'media-views',
		] );
		...
		$wp_scripts->add( 'media-audio-widget', "/wp-admin/js/widgets/media-audio-widget$suffix.js", [
			'media-widgets',
			'media-audiovideo',
		] );
		$wp_scripts->add( 'media-image-widget', "/wp-admin/js/widgets/media-image-widget$suffix.js", [ 'media-widgets' ] );
		$wp_scripts->add( 'media-video-widget', "/wp-admin/js/widgets/media-video-widget$suffix.js", [
			'media-widgets',
			'media-audiovideo',
		] );
		$wp_scripts->add( 'text-widgets', "/wp-admin/js/widgets/text-widgets$suffix.js", [
			'jquery',
			'editor',
			'wp-util',
		] );
