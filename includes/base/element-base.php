...
abstract class Element_Base extends Controls_Stack {
	...
	public function print_template() {
		...
		$content_template = Utils::apply_filters_deprecated( 'elementor/elements/print_template', [
			$content_template,
			$this,
		], '1.0.10', 'elementor/element/print_template' );
        ...
        <script type="text/html"
                id="tmpl-elementor-<?php echo $this->get_type(); ?>-<?php echo esc_attr( $this->get_name() ); ?>-content">
