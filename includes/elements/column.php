...
class Element_Column extends Element_Base {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control( '_inline_size', [
		...
		$this->add_control( 'space_between_widgets', [
		...
		$this->add_control( 'screen_sm_width', [
				'label' => __( 'Column Width', 'elementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'10' => '10%',
        ...
        <div class="elementor-element-overlay">
            <ul class="elementor-editor-element-settings elementor-editor-column-settings">
                <li class="elementor-editor-element-setting elementor-editor-element-trigger"
                    title="<?php printf( __( 'Edit %s', 'elementor' ), __( 'Column', 'elementor' ) ); ?>"><i
                            class="eicon-column"></i></li>
