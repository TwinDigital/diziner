...
class Element_Section extends Element_Base {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control( 'custom_height_inner', [
				'label' => __( 'Minimum Height', 'elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 400,
		...
		$this->add_control( 'column_position', [
		...
		$this->add_control( 'background_overlay_hover_transition', [
				'label' => __( 'Transition Duration', 'elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0.3,
		...
		$this->add_control( 'border_hover_transition', [
				'label' => __( 'Transition Duration', 'elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0.3,
		...
		foreach (
			...
			$this->start_controls_tab( "tab_$base_control_key", [
					'label' => $side_label,
				] );

			$this->add_control( $base_control_key, [
			...
			$this->add_control( $base_control_key . '_color', [
			...
			$this->add_responsive_control( $base_control_key . '_width', [
			...
			$this->add_responsive_control( $base_control_key . '_height', [
					'label' => __( 'Height', 'elementor' ),
					'type' => Controls_Manager::SLIDER,
					'range' => [
						'px' => [
			...
			$this->add_control( $base_control_key . '_flip', [
			...
			$this->add_control( $base_control_key . '_negative', [
			...
			$this->add_control( $base_control_key . '_above_content', [
		...
		$this->add_control( 'color_link_hover', [
		...
		// Section Responsive
		$this->start_controls_section( '_section_responsive', [
				'label' => __( 'Responsive', 'elementor' ),
				'tab' => Controls_Manager::TAB_ADVANCED,
			] );

		$this->add_control( 'reverse_order_mobile', [
		...
		$this->add_control( 'heading_visibility', [
	...
	protected function render_edit_tools() {
        ...
        <div class="elementor-element-overlay">
            <ul class="elementor-editor-element-settings elementor-editor-section-settings">
                <li class="elementor-editor-element-setting elementor-editor-element-trigger elementor-active"
                    title="<?php printf( __( 'Edit %s', 'elementor' ), __( 'Section', 'elementor' ) ); ?>"><i
                            class="eicon-section"></i></li>
                ...
                <# if ( ! isInner ) { #>
                    ...
                    <li class="elementor-editor-element-setting elementor-editor-element-<?php echo $edit_tool_name; ?>"
                        title="<?php echo $edit_tool['title']; ?>">
	...
	public function before_render() {
			...
			if ( $settings['background_video_link'] ) :
                ...
                <div class="elementor-background-video-container elementor-hidden-phone">
					<?php if ( $video_properties ) : ?>
                        <div class="elementor-background-video-embed"></div>
					<?php else : ?>
                        <video class="elementor-background-video-hosted elementor-html5-video" autoplay loop
                               muted></video>
					<?php endif; ?>
                </div>
				<?php
		...
		$has_background_overlay = in_array( $settings['background_overlay_background'], [
				'classic',
				'gradient',
